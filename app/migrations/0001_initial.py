# Generated by Django 3.1 on 2020-11-25 12:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('Europe', (('PT', 'Portugal'), ('ES', 'Spain'), ('FR', 'France'), ('NL', 'The Netherlands'), ('EN', 'England'), ('DE', 'Germany'))), ('America', (('CA', 'Canada'), ('US', 'United States of America'), ('BR', 'Brazil'))), ('Africa', (('AL', 'Algeria'), ('AN', 'Angola'))), ('Asia', (('CH', 'China'), ('CM', 'Cambodia'), ('IN', 'India'), ('JA', 'Japan'))), ('Oceania', (('AU', 'Australia'), ('NZ', 'New Zealand'), ('PO', 'Polynesia')))], max_length=100)),
